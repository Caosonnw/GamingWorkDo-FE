...
export default function Product() {
  ...
  const products: any[] = productListQuery.data?.payload.data ?? []
      ...
      >
        {products.map((item) => {
          const selectedVariant =
            item.product_variants.find((variant: any) => variant.variant_id === selectedVariants[item.product_id]) ||
            item.product_variants[0]

          return (
            <SwiperSlide key={products.indexOf(item)}>
              <div
                key={item.product_id}
              ...
              >
                <div className='product-card-inner flex-card-inner'>
                  <div className='product-card-image card__media'>
                    <a href='#' className='default-img img-wrapper product__media-item'>
                      <img src={selectedVariant?.product_image_main} alt={item.product_name} width={600} height={600} />
                    </a>
                    <a href='#' className='hover-img img-wrapper'>
                      <img
                        src={selectedVariant?.product_image_hover}
                    ...
                    <div className='pro-btn-wrapper'>
                      ...
                      <div className='pro-btn pro-compare'>
                        <label>
                          ...
                          <a className='compare-now' href='#' style={{ display: 'none' }}>
                            Compare Now
                          </a>
                          <input
                            type='checkbox'
                      ...
                      <div className='pro-btn'>
                        <a href='#' className='qv-btn quickview-btn' data-handle='nintendo-switch-lite-turquoise'>
                          <svg
                            xmlns='http://www.w3.org/2000/svg'
                            width={17}
                            height={16}
                  ...
                  <div className='product-content text-black'>
                    ...
                    <div className='product-content-bottom'>
                      <div className='product-rating flex items-center !mb-[10px]'>
                        <Rating defaultValue={selectedVariant?.rating} readOnly className='text-white'>
                      ...
                      <div className='product-variation-wrapper'>
                        <select
                          className='nice-select select__select'
                          value={selectedVariant.variant_id}
                          onChange={(e) => handleVariantChange(item.product_id, Number(e.target.value))}
                        >
                      ...
                      <div className='product-price-wrapper flex items-center justify-between'>
                        <div className='price'>
                          <p className='price-item font-bold text-[22px] text-white'>
